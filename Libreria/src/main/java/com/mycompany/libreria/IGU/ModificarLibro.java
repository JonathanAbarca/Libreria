...
public class ModificarLibro extends javax.swing.JFrame {
    ...
    public ModificarLibro(int id_libro,GestionLibros miGestionLibros) {        
         num_book = id_libro;
         miGestion = miGestionLibros;
        initComponents();
        cargarParaModificar(num_book);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        miControl.modificarLibro(miBook,titulo, autor, editorial, miFecha, disponible);
        
        miGestion.cargarTabla();
       // Mostrar un mensaje de diálogo con un mensaje y un título personalizado
        JOptionPane.showMessageDialog(null, "Libro modificado con éxito", "Modificar libro", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void cargarParaModificar(int idModificar){
        miBook = new Book();
        miControl = new Controlador();        
        miBook = miControl.cargarParaModificar(idModificar);        
        txtTitulo.setText(miBook.getTitulo());
        txtAutor.setText(miBook.getAutor());
        txtEditorial.setText(miBook.getEditorial());
